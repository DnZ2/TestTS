...
import { useGetElectronicsQuery } from '../app/redux/api'
...
const ElectronicsPage = () => {
  ...
  const {data, isLoading} = useGetElectronicsQuery({page: page, per_page: 8, sort: sortValue, search: debouncedSearch})
